...
# ===========================================================================
HOST = "suraj"   # shown as  you@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Aspiring Software Engineer"),
    ("kv", "Focus", "Full Stack Engineering & AI/ML"),
    ("kv", "Interest", "System Design, Scalable Systems"),
    ("kv", "Edu", "BS CS&IT, TU Nepal '28"),
    ("gap",),
    ("sec", "Stack"),
    ...
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Passionate about building reliable systems"),
    ("bul", "Always learning new technologies and best practices"),
]
